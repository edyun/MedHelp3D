...
$idcateg = $_GET["id"];
if($idcateg == 1)
	$titlupag = 'Ventilatoare artificale';
	
if($idcateg == 2)
	$titlupag = 'Ochelari / Protectie pentru fata';
	
if($idcateg == 3)
	$titlupag = 'Alte echipamente de protectie';
	
if($idcateg == 4)
	$titlupag = 'Casti de protectie';
	
if($idcateg == 5)
	$titlupag = 'Masti complete';
...
$total = "SELECT id, nume, poza, link FROM listari WHERE categorie = '$idcateg'";

$sql = "SELECT id, nume, poza, link FROM listari WHERE categorie = '$idcateg' ORDER BY id DESC LIMIT $recorduri, 12";
